  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-4">Find Your Tribe</h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg">Join communities that match your vibe and level up together</p>
        </div>
